...
public class LearnTreeMap {
    public static void main(String[] args) {
        ...
        // In TreeMap, data will be sorted according to Key values as it uses BINARY SEARCH TREE internally
        // If keys are String then values will be sorted according to their Lexicographical order....
        ...
        numbers.remove("Three"); // removes a key value pair
        System.out.println("numbers after remove Three = " + numbers);
